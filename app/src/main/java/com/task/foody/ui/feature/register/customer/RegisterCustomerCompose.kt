...
@Preview
@Composable
fun RegisterCustomerViewPreview() {
...
@Composable
fun RegisterCustomerView(
    state: RegisterCustomerUiState,
    ...
    Column(
        ...
        Text(
            text = "ثبت نام", fontSize = 36.sp, color = MaterialTheme.colorScheme.onSurface
        )
        ...
        FoodyInputView(
            value = state.name, onValueChange = onNameChange, placeHolder = "نام و نام خانوادگی"
        )
